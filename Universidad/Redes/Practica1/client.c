...
printf("2. DAY\n");
printf("3. DAYTIME\n");
printf("Indique la petición a realizar: ");
scanf("%d", &option);
}
switch (option) {
case 1:
...
int sent = sendto(clientSocket, (char *) &data, dataLength, 0, (struct
sockaddr *) &Server, serverLength);
...
int received = recvfrom(clientSocket, (char *) &data, dataLength,
0, (struct sockaddr *) &Server, &serverLength);
if(received > 0)
