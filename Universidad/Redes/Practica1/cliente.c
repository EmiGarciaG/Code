...
int main(){
    ...
    /*---------------------------------------------------------------------
			Select para comprobar si el servidor esta activo
   		----------------------------------------------------------------------*/
    ...
    /*-----------------------------------------------------------------------
		...
		-----------------------------------------------------------------------*/
    char enviado=sendto(Socket_Cliente, (char *)&Datos, sizeof(Datos), 0, (struct sockaddr *)&Servidor, Longitud_Servidor);
    /*----------------------------------------------------------------------
			Esperamos la respuesta del Servidor
		----------------------------------------------------------------------- */
    char recibido=recvfrom(Socket_Cliente, (char *)&Datos, sizeof(Datos), 0, (struct sockaddr *)&Servidor, &Longitud_Servidor);
    if(recibido=='DAY'){
